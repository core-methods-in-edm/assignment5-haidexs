...
# Part I
## Build a classification tree to predict behavior
```{r }
...
To conclude, I would recommend to pay more attention to number of hints (hints) and total number of problems solved before (prior_prob_count). Finally, based on this dataset, it seems to